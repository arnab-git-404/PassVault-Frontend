  ...
  return (
    <div className=" min-h-screen flex flex-col">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 mt-10">
        <div className="max-w-2xl w-full border-2 dark:border-white/50 rounded-xl p-8 shadow-lg">
          ...
          <div className=" border-2 bg-opacity-50 p-6 rounded-lg mb-8 border-l-4 border-blue-500">
