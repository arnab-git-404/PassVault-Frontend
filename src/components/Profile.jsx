...
export default function Profile() {
  ...
  return (
    <div className=" mx-auto p-4">
      <div className=" md:w-lg  p-6 rounded-lg shadow-2xl border-2 ">
        ...
        <div className="mb-4">
          <p className="">Two-Factor Authentication:</p>
        ...
        <div className="flex flex-col gap-3 mt-4">
          <Button className=" hover:bg-blue-700 px-4 py-2 rounded hover:cursor-pointer">
